...
DRIVER_KEY, OPTIONS_KEY, CAPABILITIES_KEY = 'DRIVER', 'OPTIONS', 'CAPABILITIES'
WEBDRIVER_BROWSERS = {'CHROME': {DRIVER_KEY: wd.Chrome,
                                 OPTIONS_KEY: wd.chrome.options.Options,
                                 CAPABILITIES_KEY: wd.DesiredCapabilities.CHROME},
                      'FIREFOX': {DRIVER_KEY: wd.Firefox,
                                  OPTIONS_KEY: wd.FirefoxOptions,
                                  CAPABILITIES_KEY: wd.DesiredCapabilities.FIREFOX}}
...
LUNG_PREF_ARGS = "prefs", {"intl.accept_languages": "en-EN"}
